<%@page import="model.domain.ProVo"%>
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<%
	                               List<ProVo> list = (List<ProVo>)(session.getAttribute("proList"));
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2><%= tempPro.getProPrice() %></h2>
										<p>$<%= tempPro.getProName() %></p>
                        ...
                        <div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shop/<%= tempPro.getCatCode() %>/<%= tempPro.getProCode() %>_1.jpg" alt="" />
										<h2><%= tempPro.getProPrice() %>원</h2>
										<p><%= tempPro.getProName() %></p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>장바구니 담기</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
											<p><%= tempPro.getProDetails() %></p>
											<h2><%= tempPro.getProPrice() %>원</h2>
											<p><%= tempPro.getProName() %></p>
											<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>장바구니 담기</a>
										</div>
                       ...
                       <li><a href="shop.jsp?pg=<%=startPage-1%>"><!-- <i class="fa fa-long-arrow-left"> --></i>Previous Page</a></li>
		                  <%
		                     for(int i=startPage; i<= endPage; i++){
		                        if(i==pg){
		                  %>
		                           <li class="active"><a href="shop.jsp?pg=<%=i %>"><%=i %></a></li>
		                  <%
		                        }else{
		                  %>
		                           <li><a href="shop.jsp?pg=<%=i %>"><%=i %></a></li>
		                  <%
		                        }
		                     }
		                  %>
	                   <li><a href="shop.jsp?pg=<%=endPage+1%>">Next Page<!-- <i class="fa fa-long-arrow-right"></i> --></a></li>
                    </ul><!--/.pagination-->
					</div><!--features_items-->
				</div>
			</div>
