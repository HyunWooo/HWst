...
public final class sSignup_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("UTF-8");
      ...
      if (_jspx_eval_c_005fchoose_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /sSignup.jsp(16,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
session.invalidate();
          ...
          // /sSignup.jsp(23,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
session.invalidate();
  ...
  private boolean _jspx_meth_c_005fwhen_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, PageContext _jspx_page_context)
    ...
    // /sSignup.jsp(10,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fotherwise_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_005fotherwise_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t\t}\r\n");
        out.write("\t\t</script>\r\n");
        out.write("\t\t<script src=\"js/jquery-1.11.3.js\" type=\"text/javascript\">\r\n");
        out.write("\t\t\t\t\tfunction chk(id) {\r\n");
        out.write("\t\t\t\t\t\talert(\"asd\");\r\n");
        out.write("\t\t\t\t\t\t$.ajax({\r\n");
        ...
        out.write("\t\t        $.ajax({\r\n");
        out.write("\t\t        type: \"POST\",\r\n");
        out.write("\t\t        url: \"checkId.do\", //이페이지에서 중복체크를 한다\r\n");
        out.write("\t\t        data: \"id=\"+ id ,//test.asp에 id 값을 보낸다\r\n");
        out.write("\t\t        cache: false,\r\n");
        out.write("\t\t        success: function(data){\r\n");
        out.write("\t\t            $(\"#confirmView\").html(data); //해당 내용을 보여준다\r\n");
        out.write("\t\t        }\r\n");
        out.write("\t\t        });\r\n");
        out.write("\t\t    });\r\n");
        out.write("\t\t });\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t<h2>판매자 회원가입</h2>\r\n");
        out.write("\t\t\t\t\t\t\t\t<form  action=\"signupSellerProcess.do\" method=\"post\" name=\"userinput\" onSubmit=\"return checkIt()\" >\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<input type=\"email\" placeholder=\"아이디(이메일)\" id = \"usrId\" name=\"usrId\"  />\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<span id=\"chkResult\"></span>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<input type='button'  placeholder = '중복확인 ' id=\"chkButton\" name = \"chkButton\" onclick=\"chk(userId.value)\">\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t\t<input type=\"hidden\" placeholder=\"회원구분\" name=\"userSection\" value=\"2\"/>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"입금계좌은행명\" name=\"bankName\"/>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"계좌번호\" name=\"accountNo\"/>\r\n");
